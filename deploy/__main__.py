...
def get_args(args):
    ...
    precomp_args.add_argument("--region-selector", type=str, default="", help="A Regex of cloud regions (and vendors) to use for the precomputation, e.g., \'aws-eu\' for all AWS regions in Europe or \'aws|azure\' for all regions of AWS and Azure. Defaults to all available regions (\'\')")
    precomp_args.add_argument("--object-store-selector", type=str, help="A Regex of object storage tiers to use for the precomputation.")
