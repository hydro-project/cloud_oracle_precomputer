...
pub fn skypie_precomputation_hydroflow(regions: Vec<Region>, object_stores: Vec<ObjectStore>, replication_factor: usize, batch_size: usize) -> Vec<Decision> {
...
mod tests {
    ...
    #[test]
    fn test_skypie_precomputation_hydroflow() {
