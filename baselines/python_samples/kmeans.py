from sky_pie_baselines import KmeansOptimizer, Workload
...
max_iterations = 100
verbose = 0
optimizer = KmeansOptimizer(network_file, object_store_file, object_stores, application_regions, num_replicas, max_iterations, verbose=verbose, max_num_replicas=max_num_replicas)
