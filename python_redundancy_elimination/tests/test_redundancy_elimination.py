import unittest
import numpy as np
from ..src.skypie_redundancy_elimination.redundancy_elimination_cvxpy import redundancyElimination as redundancyEliminationCVXPY
from ..src.skypie_redundancy_elimination.redundancy_elimination_mosek import redundancyElimination as redundancyEliminationMosek
