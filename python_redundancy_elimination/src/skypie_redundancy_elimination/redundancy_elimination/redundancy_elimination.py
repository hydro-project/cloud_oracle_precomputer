...
from skypie_redundancy_elimination.util.Enums import MosekOptimizerType, NormalizationType
from skypie_redundancy_elimination.util import Timer
...
def redundancyElimination(*, inequalities: "np.ndarray", verbose=0, normalize=NormalizationType.No, lastColSpecial = False, nonnegative = True, optimizerType = MosekOptimizerType.Free, optimizerThreads = 0, timer: "Timer|None" = None, equalities: "np.ndarray" = None, knownIrredundant: "Set[int]" = set(), overestimate = True, **ignoreArgs) -> List[Tuple[bool,float]]:
    ...
    try:
        from .redundancy_elimination_mosek import redundancyElimination as redundancyEliminationMosek
        ...
        from .redundancy_elimination_cvxpy import redundancyElimination as redundancyEliminationCVXPY
